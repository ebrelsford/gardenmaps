var GardenMap = {
    ...
    init: function(options, elem) {
        ...
        var mapbox = new OpenLayers.Layer.XYZ('mapbox', [
            'https://api.mapbox.com/styles/v1/ebrelsford/ckb3s9rri1zs81itct2splns9/tiles/256/${z}/${x}/${y}@2x?access_token=pk.eyJ1IjoiZWJyZWxzZm9yZCIsImEiOiI2VFFWT21ZIn0.qhtAhoVTOPzFwWAi7YHr_Q',
        ], {
    ...
    addSurveyedGardens: function() {
        var layer = this.getLayer('surveyed_gardens', this.defaultStyle);
        this.addStyles(layer);
        return layer;
    },

    addUnsurveyedGardens: function() {
        return this.getLayer('unsurveyed_gardens', this.unsurveyedStyle);
    },
    ...
    createAndOpenPopup: function(feature) {
        var content = "<div style=\"min-width: 450px; min-height: 250px;\"></div>";
        var t = this;
